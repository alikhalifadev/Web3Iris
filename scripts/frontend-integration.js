 ...
 * This file demonstrates how to integrate Web3iris with a web frontend
 */

// For React/Vue/Angular applications
export class Web3irisClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new Web3irisClient(provider, contractAddress);
